...
public class rateCourse extends AppCompatActivity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        courseName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() 
        {
            ...
            {
                // method is called when the user selects something from the first spinner on
                // the rating page
                // listener is used to check the first spinner, not the second one that we want
                // to populate
                courseSelection();
    ...
    class backgroundTask extends AsyncTask<String, String, String> 
    {
        ...
        protected String doInBackground(String... params) 
        {
            ...
            try 
            {
                ...
                // doesn't support HTTPS as this isn't about security, rather than
                // functionality(pretty sure i had to force it to use clear text?)
                URL url = new URL("http://192.168.1.2/api/insert.php");
                // url parameters that get added on to the url to POST
                String urlParams = "rating=" + rating + "&name=" + courseName + "&number=" + courseNumber + "&comments="
                        + comments + "&professor=" + professor;
